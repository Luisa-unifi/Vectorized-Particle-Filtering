...
for i in range(1):
    ...
    ess = ess+[tf.reduce_sum(EW)**2/(tf.reduce_sum(EW**2))] 
    ...
    width=(l_U-l_L)/2
    widths=widths+[width]
    expectations=expectations+[l_L+width]
...
print("average expectation: ",sum(expectations)/len(expectations))
print("average ess: ",sum(ess)/len(ess))
